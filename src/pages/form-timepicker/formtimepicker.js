...
import { Button, Col, DatePicker, message, Row, Select, Spin, Typography } from 'antd';
import { useDispatch, useSelector } from 'react-redux';
import { getListTime, upTimeDate } from '../../features/timeDateSlice/timeDateSlice';
...
const Formtimepicker = () => {
	...
	const { listSemesters, defaultSemester } = useSelector((state) => state.semester);
	...
	const onSaveTime = async (value) => {
		...
		if (
			...
			message.error('Bạn phải đặt thời gian trong khoảng thời gian của kỳ thực tập');
		}
	};
